<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-between mt-4 text-black">
            ...
            <!-- Log in button -->
            <button type="submit" class="ms-3 bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-500 rounded-md py-2 px-4">
                {{ __('Log in') }}
            </button>
        </div>
    </form>
